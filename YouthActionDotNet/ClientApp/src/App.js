      ...
      <div className="App" style={{ maxHeight: height }}>
        ...
        <div className="App-header" style={{ maxHeight: height - 56 }}>
          ...
          <Routes>
            <Route
              path="/"
              element={<Login setToken={setToken} setPerms={setPerms}></Login>}
            ></Route>
        ...
        <header className="App-header" style={{ maxHeight: height - 56 }}>
          ...
          <Routes>
            {token.data.Role == "Admin" && (
              <Route
                path="/"
                element={<Home user={token} permissions={parsedPerms} />}
              />
            )}
            {token.data.Role == "Donor" && (
              <Route
                path="/"
                element={
                  <DonorDashboard user={token} permissions={parsedPerms} />
                }
              />
            )}
            {token.data.Role == "Volunteer" && (
              <Route
                path="/"
                element={
                  <VolunteerHome user={token} permissions={parsedPerms} />
                }
              />
            )}
            ...
            <Route
              path="/Users"
              element={<Users user={token} permissions={parsedPerms} />}
            />
            <Route
              path="/Employees"
              element={<Employees user={token} permissions={parsedPerms} />}
            />
            <Route
              path="/Volunteers"
              element={<Volunteer user={token} permissions={parsedPerms} />}
            />
            <Route
              path="/volunteer-Registration"
              element={
                <VolunteerRegistration user={token} permissions={parsedPerms} />
              }
            />
            <Route
              path="/Donors"
              element={<Donors user={token} permissions={parsedPerms}></Donors>}
            />
            <Route
              path="/Donations"
              element={
                <Donations user={token} permissions={parsedPerms}></Donations>
              }
            />
            <Route
              path="/DonorDashboard"
            ...
            <Route
              ...
              element={<View user={token} permissions={parsedPerms} />}
            />
            <Route
              path="/Project/Edit/:id"
              element={<Edit user={token} permissions={parsedPerms} />}
            />
            <Route
              path="/Expenses"
